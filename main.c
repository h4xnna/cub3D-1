...
/*   Updated: 2026/01/10 19:14:16 by pacda-si         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "cub3d.h"

static void	final_initializations(t_data *data)
{
...
static int	init_data(t_data **data, int fd)
{
...
static int	initialize_everything(t_data **data, int ac, char **av)
{
	int	fd;
